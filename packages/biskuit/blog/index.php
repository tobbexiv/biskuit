...
use Biskuit\Blog\Content\ReadmorePlugin;
use Biskuit\Blog\Event\PostListener;
use Biskuit\Blog\Event\RouteListener;
...
return [
    ...
    'nodes' => [
        ...
        'blog' => [
            'name' => '@blog',
            'label' => 'Blog',
            'controller' => 'Biskuit\\Blog\\Controller\\SiteController',
            'protected' => true,
            'frontpage' => true
        ]
    ...
    'routes' => [
        ...
        '/blog' => [
            'name' => '@blog',
            'controller' => 'Biskuit\\Blog\\Controller\\BlogController'
        ],
        '/api/blog' => [
            'name' => '@blog/api',
            'controller' => [
                'Biskuit\\Blog\\Controller\\PostApiController',
                'Biskuit\\Blog\\Controller\\CommentApiController'
            ]
        ]
