                        ...
                        <form class="uk-form uk-form-horizontal tm-form-horizontal" v-validator="formDatabase" @submit.prevent="stepDatabase | valid">
                            ...
                            <div class="uk-form-row" v-if="config.database.default == 'mysql'">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="form-mysql-dbprefix" class="uk-width-1-1" type="text" name="mysqlprefix" value="bk_" v-model="config.database.connections.mysql.prefix" v-validate:pattern.literal="/^[a-zA-Z][a-zA-Z0-9._\-]*$/">
                            ...
                            <div class="uk-form-row" v-show="config.database.default == 'sqlite'">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="form-sqlite-dbprefix" class="uk-width-1-1" type="text" name="sqliteprefix" value="bk_" v-model="config.database.connections.sqlite.prefix" v-validate:pattern.literal="/^[a-zA-Z][a-zA-Z0-9._\-]*$/">
