...
/**
 * This class specifies all Biskuit requirements and optional recommendations.
 *
 * @author Tobias Schultze <http://tobion.de>
 * @author Fabien Potencier <fabien@symfony.com>
 */
class BiskuitRequirements extends RequirementCollection
{
    ...
    public function __construct($path)
    {
        ...
        $this->addRequirement(
            ...
            sprintf('You are running PHP version "<strong>%s</strong>", but Biskuit needs at least PHP "<strong>%s</strong>" to run.
                Before using Biskuit, upgrade your PHP installation, preferably to the latest version.',
...
return new BiskuitRequirements($path);
