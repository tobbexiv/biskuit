<?php return array (
  ...
  'Roles' => 'Roles',
  'Access' => 'Acceso',
  'Manage media files' => 'Administrar archivos multimedia',
  'Manage menus' => 'Administrar menus',
  'Manage widgets' => 'Administrar widgets',
  'Manage themes' => 'Administrar temas',
  'Manage extensions' => 'Administrar extensiones',
  'Apply system updates' => 'Aplicar actualización de sistema',
  'Access admin area' => 'Acceso area administrador',
  'Access system settings' => 'Acceso ajustes de sistema',
  'Manage user permissions' => 'Administrar permisos de usuario',
  'Manage users' => 'Administrar usuarios',
  'Use the site in maintenance mode' => 'Usar sitio en modo mantenimiento',
  'Warning: Give to trusted roles only; this permission has security implications.' => 'Advertencia: Dar a los roles de confianza solamente; este permiso tiene implicaciones de seguridad.',
  'Cache' => 'Caché',
  'Save' => 'Guardar',
  'Developer' => 'Desarrollador',
  'Disable cache' => 'Desactivar caché',
  'Clear Cache' => 'Limpiar caché',
  'Select Cache to Clear' => 'Seleccionar caché a limpiar',
  ...
  'Show on all posts' => 'Mostrar todas las Publicacines',
  'Only show on first post.' => 'Mostrar sólo en primer entrada',
  'Unable to retrieve feed data.' => 'Incapaz de recuperar datos',
  'No URL given.' => 'Ninguna URL dado',
  'Unit' => 'Unidad',
  'Metric' => 'Métrico',
  'Imperial' => 'Imperial',
  'Dashboard' => 'Escritorio',
  'Widget deleted.' => 'Widget borrado',
  'Widgets reordered.' => 'Widget reordenado',
  'Biskuit %version% is available.' => '',
  'Add Widget' => '',
  'Select Link' => '',
  ...
  'Loop' => 'Bucle',
  'Muted' => 'Mudo',
  'Poster Image' => 'Imagen de poster',
  'File' => '',
  'Name' => 'Nombre',
  'Add Folder' => 'Agregar folder',
  '{0} %count% Files|{1} %count% File|]1,Inf[ %count% Files' => '',
  'Home' => 'Inicio',
  'Folder Name' => 'Nombre del folder',
  'Rename' => 'Renombrar',
  'Upload' => 'Subir',
  ...
  'Site Locale' => '',
  'Admin Locale' => '',
  'Is your language not available? Please help out by translating Biskuit into your own language on %link%.' => '',
  'Enable debug mode' => '',
  ...
  'Reset Password' => '',
  'Update Biskuit' => '',
  'Biskuit has been updated! Before we send you on your way, we have to update your database to the newest version.' => '',
  'Visit Site' => '',
  'Logout' => '',
  ...
  'Your Biskuit database has been updated successfully.' => '',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => '',
  ...
  'You have the latest version of Biskuit.' => '',
  'You have the latest version of Biskuit. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => '',
  'Download %version%' => '',
  'Changelog' => '',
);