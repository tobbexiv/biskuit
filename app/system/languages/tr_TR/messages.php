<?php return array (
  ...
  'Biskuit %version% is available.' => 'Biskuit %version% sürümü yayınlanmış.',
  ...
  'Setting' => 'Ayar',
  'Value' => 'Değer',
  'Biskuit Version' => 'Biskuit Sürümü',
  ...
  'Is your language not available? Please help out by translating Biskuit into your own language on %link%.' => 'Dilinizi bulamadınız mı? Biskuit çevirisine yardımcı olmak için %link% bağlantısına bakabilirsiniz. ',
  ...
  'Update Biskuit' => 'Biskuit Yazılımını Güncelle',
  'Biskuit has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'Biskuit güncellendi. Kullanmaya başlamadan önce veritabanınızın da güncellenmesi gerekiyor. ',
  ...
  'Your Biskuit database has been updated successfully.' => 'Biskuit veritabanı güncellendi.',
  ...
  'Biskuit Installer' => 'Biskuit Yükleyicisi',
  'Marketplace' => 'Mağaza',
  'Themes' => 'Temalar',
  ...
  'No Biskuit %type%' => 'Biskuit %type% yok',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => 'Varolan bir Biskuit kurulumu algılandı. Farklı bir tablo öneki seçmek ister misiniz?',
  ...
  'You have the latest version of Biskuit.' => 'Son Biskuit sürümünü kullanıyorsunuz.',
  'You have the latest version of Biskuit. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Son Biskuit sürümünü kullanıyorsunuz. Herhangi bir güncelleme gerekmiyor. Bununla birlikte %version% sürümünü yeniden yüklemek istiyorsanız, paketi indirip el ile yeniden yükleyebilirsiniz.',
