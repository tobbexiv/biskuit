<?php return array (
  ...
  'Biskuit %version% is available.' => 'E\' disponibile la versione %version% di Biskuit. Aggiorna ora...',
  ...
  'Value' => 'Valore',
  'Biskuit Version' => 'Versione Biskuit',
  ...
  'Testemail' => 'Email test inviata da Biskuit',
  ...
  'Is your language not available? Please help out by translating Biskuit into your own language on %link%.' => 'La tua lingua non è disponibile? Aiutaci a tradurre Biskuit nella tua lingua su %link%',
  ...
  'Hello!' => 'Ciao!',
  'A new user signed up for %site% with the username %username%. Please click the button below to approve the account.' => 'Un nuovo utente si è registrato nel sito %site% con il nome utente %username%. Fare clic sul pulsante qui sotto per approvare la registrazione.',
  ...
  'Your Biskuit database has been updated successfully.' => 'Il database di Biskuit è stato aggiornato con successo.',
  ...
  'Biskuit Installer' => 'Installazione del Biskuit',
  'Marketplace' => 'Mercato',
  'Themes' => 'Temi',
  ...
  'No Biskuit %type%' => 'Nessun %type% di Biskuit',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => 'Rilevata installazione Biskuit esistente. Scegli un prefisso di tabella diverso?',
  'Database connection failed!' => 'Connessione al database non riuscita!',
  'Database access denied!' => 'Accesso al database negato!',
  ...
  'Folder' => 'Cartella',
  'No extension found.' => 'Nessuna estensione trovata.',
