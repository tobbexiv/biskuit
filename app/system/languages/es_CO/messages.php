<?php return array (
  ...
  'Biskuit %version% is available.' => 'Biskuit %version% esta disponible.',
  ...
  'Is your language not available? Please help out by translating Biskuit into your own language on %link%.' => '¿Tu lenguaje no esta disponible? Ayúdanos traduciendo Biskuit en tu propio idioma en %link%.',
  ...
  'Biskuit has been updated! Before we send you on your way, we have to update your database to the newest version.' => '¡Biskuit ha sido actualizado! Antes de continuar, tenemos que actualizar tu base de datos a la nueva versión.',
  ...
  'Your Biskuit database has been updated successfully.' => 'Tu base de datos de Biskuit ha sido correctamente actualizada.',
  ...
  'No Biskuit %type%' => 'Sin Biskuit %type%',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => 'Se detecto una instalación previa de Biskuit. ¿Escoger un prefijo de tabla diferente?',
  ...
  'You have the latest version of Biskuit.' => 'Tienes la última versión de Biskuit.',
  'You have the latest version of Biskuit. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Tienes la última versión de Biskuit. No necesitas actualizar. Sin embargo, si quieres reinstalar la versión %version%, puedes descargar el paquete y reinstalar manualmente.',
