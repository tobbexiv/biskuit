<?php return array (
  ...
  'Biskuit %version% is available.' => 'Biskuit %version% on saadaval.',
  ...
  'Setting' => 'Seaded',
  'Value' => 'Väärtus',
  'Biskuit Version' => 'Biskuiti versioon',
  ...
  'Update Biskuit' => 'Uuenda Biskuit\'i',
  'Biskuit has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'Biskuit on uuendatud! Enne kui saad süsteemi kasutada peab uuendama andmebaasi uuemaks versiooniks.',
  ...
  'Your Biskuit database has been updated successfully.' => 'Teie Biskuiti andmebaasi uuendus õnnestus.',
  ...
  'Biskuit Installer' => 'Biskuit Instaleerija',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => 'Leiti olemasolev Biskuiti instalatsioon. Valige erinev preffiks.',
  ...
  'You have the latest version of Biskuit.' => 'Teil on Biskuiti viimane versioon',
  'You have the latest version of Biskuit. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Teil on Biskuiti viimane versioon. Te ei pea uuendama. Kui siiski soovite eemaldada versiooni %version% võite paketi käsitsi alla laadida ja instaleerida paketi seejärel käsitsi.',
