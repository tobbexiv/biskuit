<?php return array (
  ...
  'Biskuit %version% is available.' => 'Biskuit %version% is beschikbaar.',
  ...
  'Setting' => 'Instelling',
  'Value' => 'Waarde',
  'Biskuit Version' => 'Biskuit versie',
  ...
  'Is your language not available? Please help out by translating Biskuit into your own language on %link%.' => 'Is jouw taal niet beschikbaar? Help Biskuit met het vertalen van jouw eigen taal op %link%?',
  ...
  'Biskuit has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'Biskuit is geüpdatet. Voordat je doorgaat is het nodig om de database te updaten naar de nieuwste versie.',
  ...
  'Your Biskuit database has been updated successfully.' => 'De Biskuit-database is succesvol geüpdatet.',
  ...
  'No Biskuit %type%' => 'Geen Biskuit %type%',
  ...
  'Existing Biskuit installation detected. Choose different table prefix?' => 'Bestaande Biskuit-installatie gevonden. Ander tabelvoorvoegsel gebruiken?',
  ...
  'You have the latest version of Biskuit.' => 'Je hebt de laatste versie van Biskuit.',
  'You have the latest version of Biskuit. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Je hebt de laatste versie van Biskuit. Het is niet nodig om te updaten. Wanneer je versie %version% opnieuw wilt installeren kan dit automatisch, maar ook handmatig door het pakket opnieuw te downloaden en te installeren.',
