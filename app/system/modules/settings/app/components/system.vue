        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls uk-form-controls-text">
                ...
                <p class="uk-form-controls-condensed" v-if="$root.options['system/captcha'].recaptcha_enable">
                    <input id="form-user-recaptcha-sitekey" class="uk-form-width-large" :placeholder="$trans('Site key')" v-model="$root.options['system/captcha'].recaptcha_sitekey">
                </p>
                <p class="uk-form-controls-condensed" v-if="$root.options['system/captcha'].recaptcha_enable">
                    <input id="form-user-recaptcha-secret" class="uk-form-width-large" :placeholder="$trans('Secret key')" v-model="$root.options['system/captcha'].recaptcha_secret">
                </p>
