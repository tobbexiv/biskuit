...
return [
    ...
    'routes' => [
        ...
        '/system/finder' => [
            'name' => '@system/finder',
            'controller' => 'Biskuit\\Finder\\Controller\\FinderController'
        ],
        '/site/storage' => [
            'name' => '@site/storage',
            'controller' => 'Biskuit\\Finder\\Controller\\StorageController'
        ]
    ...
    'events' => [
        ...
        'view.scripts' => function ($event, $scripts) {
            ...
            $scripts->register('link-storage', 'system/finder:app/bundle/link-storage.js', ['~panel-link', 'panel-finder']);
        },
